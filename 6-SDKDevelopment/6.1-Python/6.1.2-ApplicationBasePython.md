...
- **Parameters:**
  - speed: (floating point type) the speed of chassis movement, the range is `0 ~ 0.5`, unit:  m/s.

### `go_back(speed)`

- **Function:** Control chassis to move backward.
- **Parameters:**
  - speed: (floating point type) chassis movement speed, range is `-0.5 ~ 0`, unit:  m/s.

### `turn_left(speed)`

- **Function:** Control the chassis to rotate to the left.
- **Parameters:**
  - speed: (floating point type) the speed of chassis movement, ranging from `0 ~ 0.5`, unit:  m/s.
